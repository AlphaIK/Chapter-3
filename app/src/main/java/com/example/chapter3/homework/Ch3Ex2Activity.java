...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator animatorX=ObjectAnimator.ofFloat(findViewById(R.id.target) ,"scaleX",1f,2f);
        ...
        ObjectAnimator animatorY=ObjectAnimator.ofFloat(findViewById(R.id.target) ,"scaleY",1f,2f);
        ...
        ObjectAnimator animator=ObjectAnimator.ofFloat(findViewById(R.id.target) ,"alpha",1f,0.5f);
        ...
        animatorSet.playTogether(animator1,animator,animatorX,animatorY);
        animatorSet.start();
    }
}
